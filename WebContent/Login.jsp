...
<h1 style="font-family:sans-serif; color: #4c92ca; display: inline-block; width: 60%" align="center">Web Legal Advice System</h1></div>
		<table id="mainTbl" style="width: 100%;" >
			<tr >
				...
				<td align="center" style="border: 1px solid black"><a href="QueryRequest.jsp" style="color: black;">QUERY REQUEST</a></td>
		...
		<table style="margin-left: 30%; width: 50%;" >
			<tr align="center">
				<td><h3><%=request.getParameter("tr")%> LOGIN</h3></td>
			</tr>
			<tr>
			<td colspan="2">
			...
			<tr>
			<td></td>
				<td><a href="forgotPwd.jsp" style="font-size: small;">Forgot Password </a>
					<!-- &nbsp; &nbsp;&nbsp;<a href="forgotUserID.html" style="font-size: small;">Forgot
						Username </a>&nbsp; &nbsp;&nbsp;
						
						<a href="Register.jsp"
					style="font-size: small;">New User ?</a> --></td>
